...
## Bonus personnel — Intégration Continue (CI)
...
À chaque Push sur les branches `main` ou `dev`, le workflow :
...
Cette démarche s'inscrit dans une logique professionnelle de qualité logicielle et de développement continu.
