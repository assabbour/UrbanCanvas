...
struct MockData {
    ...
    static let artworks: [Artwork] = [
        ...
        Artwork(
            ...
            description: "A contemporary reinterpretation of the Mona Lisa integrated into the urban landscape.",
        ...
        Artwork(
            ...
            description: "Colorful mural blending architecture and street art.",
        ...
        Artwork(
            ...
            description: "A detailed stencil portrait placed in one of Marseille's most artistic neighborhoods.",
            imageName: "chloe",
            type: .graffiti,
            condition: "Good",
            date: "2019",
        ...
        Artwork(
            ...
            city: "Paris",
            location: "Le Marais",
            description: "Pixel-art inspired mosaic installed on a Parisian street corner.",
            imageName: "pa_278",
            type: .installation,
            condition: "Excellent",
            date: "2018",
