...
struct MockData {
    ...
    static let artworks: [Artwork] = [
        ...
        Artwork(
            ...
            description: "A contemporary reinterpretation of the Mona Lisa integrated into the urban landscape.A contemporary reinterpretation of the Mona Lisa integrated into the urban landscapeA contemporary reinterpretation of the Mona Lisa integrated into the urban landscape",
        ...
        Artwork(
            ...
            description: "Colorful mural blending architecture and street armural blending architecture and street armural blending architecture and street armural blending architecture and street armural blending architecture and street art.",
        ...
        Artwork(
            ...
            description: "A detailed stencil portrait placed inportrait placed in one of Marseille's most portrait placed in one of Marseille's most portrait placed in one of Marseille's most portrait placed in one of Marseille's most  one of Marseille's most artistic neighborhoods.",
            imageName: "chloe",
            type: .graffiti,
            condition: "Good",
            date: "2019",
        ...
        Artwork(
            ...
            city: "Paris",
            location: "Le Marais",
            description: "Pixel-art inspired mosaic install-art inspired mosaic install-art inspired mosaic install-art inspired mosaic install-art inspired mosaic install-art inspired mosaic install-art inspired mosaic installed on a Parisian street corner.",
            imageName: "pa_278",
            type: .installation,
            condition: "Excellent",
            date: "2018",
        ...
        Artwork(
            ...
            city: "Paris",
            location: "Montmartre",
            description: "Expressive stencil artwork inviting passers-by to stop and observe.",
            imageName: "chuuuut",
            type: .graffiti,
            condition: "Good",
            date: "2017",
        ...
        Artwork(
            ...
            description: "Large mural representing the contrast between strength and fragility.",
